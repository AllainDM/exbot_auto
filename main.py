...
def day_north(start_day, date_now, date_for_goodscat, name_table):
    ...
    list_filter = ["Плесецкая 10", "Плесецкая 14",
                   ...
                   "Долгоозерная 41," "Долгоозерная 41к2",
                   "Долгоозерная 39",
                   "Долгоозерная 37", "Долгоозерная 37к2",
                   "Долгоозерная 31",
                   "Долгоозерная 33к1",
                   "Долгоозерная 33к2",

                   "Парашютная 33", "Парашютная 35",
                   "Парашютная 31", "Парашютная 31к2",
                   "ЖК Долгоозерный [12]",

                   "реки Каменки 19к1", "реки Каменки 19к3",
                   "реки Каменки 19к4", "реки Каменки 17к2",
                   "реки Каменки 21", "реки Каменки 23",
                   "Орлово-Денисовский 15к1", "Орлово-Денисовский 15к2",

                   "ЖК Заповедный парк [ 9]",
                   ...
                   "Авиаконструкторов 61", "Авиаконструкторов 63",
                   "ЖК Полис [ 2]"
                   ]
...
def day_east(start_day, date_now, date_for_goodscat, name_table):
    ...
    to_exel.save_to_exel_from_userside(name_table, answer, t_o)
    # ЖК Цивилизация на Неве(Архивная 9к1, 11к1; Дыбенко 4к1, 6к2: 0(7)
    # Дыбенко 7к(1, 2, 3): 0(22)
    # Дыбенко 8 к(1, 2, 3): 0(14)

    list_filter = [
        "Архивная 9к1", "Архивная 11к1",
        "Дыбенко 4к1", "Дыбенко 6к2",
        "ЖК Цивилизация на Неве (Архивная 9к1, 11к1; Дыбенко 4к1, 6к2): [ 4]",

        "Дыбенко 7к1", "Дыбенко 7к2", "Дыбенко 7к3",
        "Дыбенко 7к(1, 2, 3): [ 3]",
